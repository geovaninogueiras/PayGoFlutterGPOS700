...
public class GertecPrinter {
     ...
     *
     * */
    public boolean imprimeImagemDrawable( String imagem ) throws GediException {
     ...
     * Método que faz a impressão de imagens
     *
     * @param imagem = String em BASE64 da Imagem que deve ser impressa.
     *
     * @throws IllegalArgumentException = Argumento passado ilegal
     * @throws GediException = retorna o código do erro.
     *
     * */
    public boolean imprimeImagemBase64( String imagem ) throws GediException {

        Bitmap bmp;
        byte[] imagemByte;
        try {

            imagemByte = Base64.decode(imagem, Base64.DEFAULT);

            bmp = BitmapFactory.decodeByteArray(imagemByte, 0, imagemByte.length);
