...
class Paygogpos700 {
  ...
  static const MethodChannel _channel = const MethodChannel('paygogpos700');

  int result;
  bool informacaoConfirmacao;
  ...
  static Future<String> efetuaOperacao({
    ...
    String informaCorFonte,
    String informaCorFonteTeclado,
    String informaCorFundoCaixaEdicao,
    String informaCorFundoTela,
    String informaCorFundoTeclado,
    String informaCorFundoToolbar,
    String informaCorTextoCaixaEdicao,
    String informaCorTeclaPressionadaTeclado,
    String informaCorTeclaLiberadaTeclado,
    String informaCorSeparadorMenu,
  }) async {
  ...
  Paygogpos700.fromJson(Map<String, dynamic> json) {
    result = json['result'];
